  ...
  <body>
              ...
              <li class="nav-item">
                  ...
                  <div class="submenu">
                      <ul class="submenu-item">
                          <li class="nav-item"><a class="nav-link" href="index.php?folder=klien&page=c-lihat">Data klien</a></li>
                          ...
                          <li class="nav-item"><a class="nav-link" href="index.php?folder=absensi&page=bj-lihat">Data absensi</a></li>
                          <li class="nav-item"><a class="nav-link" href="index.php?folder=proyek&page=bj-lihat">Data proyek</a></li>
                      </ul>
                  </div>
              </li>
    ...
    <!-- partial -->
        ...
        if (file_exists($file)) {
            ...
            echo "<h2>Halaman tidak ditemukan, Sayang 😢</h2>";
        }
        ?>
				</div>
